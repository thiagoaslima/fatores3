...
import { Session, SessionRepository } from "../session/Session";
...
export class Router {
    ...
    constructor(public $stateProvider: ng.ui.IStateProvider,
        public $urlRouterProvider: ng.ui.IUrlRouterProvider) {

        this.run();
    }

    static instance($stateProvider: ng.ui.IStateProvider,
        $urlRouterProvider: ng.ui.IUrlRouterProvider) {
            
        // decorate $stateProvider
        const originalState = $stateProvider.state;

        $stateProvider.state = function(name: string, config): ng.ui.IStateProvider {
    ...
    private run(): void {
        this.$stateProvider
            ...
            .state('menu', <ng.ui.IState>{
                url: '',
                abstract: true,
                template: sidebar
            })

            .state('configuracao', <ng.ui.IState>{
                parent: 'menu',
                url: '/configuracao',
                ...
                resolve: {
                    "empresas": [Session.IID, EntitiesLoader.IID,
                        function(Session: Session, EntitiesLoader: EntitiesLoader): ng.IPromise<SessionRepository> {
